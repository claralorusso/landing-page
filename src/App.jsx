...
export default function App() {
  return (
    <>
      {/* ✅ gestisce scroll top per pagine + scroll a sezione per #hash */}
      <ScrollToTop />
      <Routes>
        ...
        <Route
          path="/digitalizzazione-agroalimentare"
          element={<DigitalizzazioneAgroalimentare />}
        />

        {/* ✅ pagine “progetto” */}
        <Route
          path="/coldsharing/perche-e-nata"
          element={<ColdsharingPercheNata />}
        />
        ...
        <Route
          path="/blog/come-e-nata-marvincla"
          element={<BlogMarvinclaOrigine />}
        />
        <Route
          path="/blog/come-si-realizzano-le-celle-frigorifere"
          element={<BlogCelleFrigorifere />}
        />
